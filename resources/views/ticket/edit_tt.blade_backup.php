...
<script type="text/javascript" src="{{asset('js/edit_tt.js?v2')}}"></script>
...
<div id="tt_form_div" class="container-fluid ">
	...
	<div id="fixed-top-menu" class="fixed-top-menu">
		<h2 class="page-title">Edit Ticket <a href="{{ url('ViewTTSingle')}}?ticket_id={{$ticketId}}" style="color:#fff"> &nbsp;&nbsp;<span class="glyphicon glyphicon-eye-open"></span></i></a>
		<small>
		<span style="background-color: #cbcfd3;border-radius: 25px;border: 2px solid white;padding: 5px;">
			
			<span style="color: black">Fault IDs ({{count($fault_lists)}}) :</span>
			@foreach($fault_lists as $key=>$value)
				<span style="color: black"><a href="#{{$value->fault_id}}" 
					title=
					...
					style="color: #6f7884" >{{$value->fault_id}}</a></span>||
			@endforeach
			<span style="color: black"><a href="#top" style="color: #6f7884" onclick="set_menu_css(-1)"><span class="glyphicon glyphicon-circle-arrow-up"></span></a></span>
			||
			<span style="color: black"><a href="#bottom" style="color: #6f7884" onclick="set_menu_css(0)"><span class="glyphicon glyphicon-circle-arrow-down"></span></a></span>
			</span>
					...
					<div class="col-md-3">
						<table>
							<tr>
								...
								@else
								<td><input type="text" name="responsible_field_team_{{$fault_count}}" id="responsible_field_team_{{$fault_count}}" class="form-control input-transparent" value="{{$fault_list->responsible_field_team}}" readonly></td>
								@endif
							</tr>
							<tr>
								<td>Provider</td>
							...
							<div class="widget-controls dropdown" required="">
								...
								<table>
									...
									<tr>
										...
										<td><input class="form-control input-transparent" name="fault_{{$fault_count}}_task_{{$task_count}}_start_time" value="{{$task_list->task_start_time}}" required type="text"></td>
										@else
