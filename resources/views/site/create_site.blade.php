					...
					<div class="col-md-12">
						...
						<table id="incident_search_table">
							...
							<tr>
								...
								<td>Site Name</td>
								<td>
									<input type="text" name="site_name" class="form-control input-transparent" required value="{{$site_name}}" list="na_list">
								</td>
								<td>MW Site Name</td>
								<td><input type="text" name="mw_site_name" class="form-control input-transparent" required value="{{$mw_site_name}}" list="na_list"></td>
							</tr>

							<tr>
								<td>Site IP Address</td>
								<td><input type="text" name="site_ip_address" class="form-control input-transparent" required value="{{$site_ip_address}}" list="na_list"></td>
								<td>Site Type</td>
							...
							<tr>
								...
								<td><input type="text" name="site_node_address" class="form-control input-transparent" required value="{{$site_node_address}}" list="na_list"></td>
