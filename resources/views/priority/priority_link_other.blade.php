...
<html lang="en">
<head>
    <title>Priority Link Other Issues</title>
    <meta charset="UTF-8">
...
<!--===============================================================================================-->
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('responsive_link_table/css/main.css?v4')}}">
<!--===============================================================================================-->
</head>
<body>
    ...
    <div class="limiter">
        <div class="container-table100">
            <div class="wrap-table100">
                <div class="table100">
                    <center><h3 style="color: white">Priority Link Other Issue List</h3></center>
                    <center>
                    ...
                    <table>
                        ...
                        <tbody>
                                ...
                                @foreach($link_other_lists as $link_other_list)
                                <tr>
                                    <td class="column1">{{ $link_other_list->ticket_id }}</td>
                                    <td class="column2"><strong>{{ $link_other_list->link_name_nttn }}</strong></td>
                                    <td class="column3"><strong>{{ $link_other_list->link_name_gateway }}</strong></td>
                                    <td class="column4">{{ $link_other_list->client_name }}</td>
                                    <td class="column5">{{ $link_other_list->problem_category }}</td>
                                    <td class="column6">{{ $link_other_list->capacity_nttn }}</td>
                                    <td class="column7">{{ $link_other_list->event_time }}</td>
                                    <td class="column8">{{ round($link_other_list->duration,2) }} Hr</td>
                                    <td class="column9">{{ $link_other_list->remark }}</td>    
                                </tr>
                                @endforeach
