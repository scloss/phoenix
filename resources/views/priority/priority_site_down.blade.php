...
<html lang="en">
<head>
    <title>Priority Site Down</title>
    <meta charset="UTF-8">
...
<!--===============================================================================================-->
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('responsive_site_table/css/main.css?v1')}}">
<!--===============================================================================================-->
</head>
<body>
    ...
    <div class="limiter">
        <div class="container-table100">
            <div class="wrap-table100">
                <div class="table100">
                    <center><h3 style="color: white">Priority Site  Down List</h3></center>
                    <center>
                    ...
                    <table>
                        ...
                        <tbody>
                                ...
                                <tr>
                                    <td class="column1">{{ $site_down_list->ticket_id }}</td>
                                    <td class="column2"><strong>{{ $site_down_list->site_name }}</strong></td>
                                    <td class="column3">{{ $site_down_list->client_name }}</td>
                                    <td class="column4">{{ $site_down_list->event_time }}</td>
                                    <td class="column5">{{ round($site_down_list->duration,2) }} Hr</td>
                                    <td class="column6">{{ $site_down_list->remark }}</td>    
                                </tr>
                                @endforeach
